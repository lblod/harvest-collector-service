  ...
  const queryStr = `
    ...
    INSERT {
      GRAPH ?g {
        ...
        ${sparqlEscapeUri(containerUri)} task:hasFile ?remoteDataObject.
        ?remoteDataObject a nfo:FileDataObject.
        ?remoteDataObject nfo:fileName ?fileName.
        ?remoteDataObject nfo:fileSize ?size.
      }
    }
    WHERE {
      GRAPH ?g {
