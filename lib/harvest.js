  ...
  try {
    ...
    if (physicalFile) {
      ...
      if (urls.length) {
        ...
        console.warn(`All files have been processed for collection ${collection}, wrapping up.`);
  ...
  setTimeout(async () => {
    for (let collection of collections) {
      ...
      if (collection && await isHarvestingCollectionDone(collection)) {
        ...
        console.warn("still ongoing, nothing else to do now");
